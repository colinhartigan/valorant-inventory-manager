...
:gotAdmin
    ...
    CD /D "%~dp0"
:--------------------------------------    
    "C:/Program Files/Python39/python.exe" -m pipreqs.pipreqs --force
	...
	"C:/Program Files/Python37/python.exe" -m PyInstaller main.py --noconfirm --icon=favicon.ico --name="VIM_test" --onefile 
	pause